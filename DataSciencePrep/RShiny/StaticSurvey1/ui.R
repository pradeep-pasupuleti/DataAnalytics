...
shinyUI(pageWithSidebar(
  ...
  sidebarPanel(
    ...
    h5("Created by:"),
    tags$a("Link to website", 
           href="http://www.datatma.com"),
    h5("For details on how data is generated:"),
    tags$a("Blog Post", 
           href=paste0("http://www.datatma.com/",
                       "2013/19/Shiny-Survey-Tool.html")),
    h5("Github Repository:"),
    tags$a("Survey-Tool", 
           href=paste0("https://github.com/datatma/",
  ...
  mainPanel(
   ...
   # uiOutput("MainAction"),
    ...
    radioButtons("survey", "Please Select:", 
                 c("Prefer not to answer", QList[1,ncol(Qlist)]))
  )
))