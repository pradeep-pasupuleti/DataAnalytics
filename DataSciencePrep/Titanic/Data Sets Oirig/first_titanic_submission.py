...
prediction_path = r'C:\Pradeep\Working Set\Consulting\Kaggle\Titanic\Data Sets Oirig\prediction.csv'
prediction_csv=pd.read_csv(prediction_path)
prediction_csv['Survived']=predictions
prediction_csv.to_csv(r'C:\Pradeep\Working Set\Consulting\Kaggle\Titanic\Data Sets Oirig\my_first_submission2.csv',
                      index =False)
