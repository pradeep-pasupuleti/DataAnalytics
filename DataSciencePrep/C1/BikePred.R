...
train<-read.table("DataSciencePrep/C1/Data/Kg/Bike/train.csv",sep=",",stringsAsFactors=FALSE,header=T,quote = "\"",allowEscapes=TRUE,fill=TRUE)
test<-read.table("DataSciencePrep/C1/Data/Kg/Bike/train.csv",sep=",",stringsAsFactors=FALSE,header=T,quote = "\"",allowEscapes=TRUE,fill=TRUE)
