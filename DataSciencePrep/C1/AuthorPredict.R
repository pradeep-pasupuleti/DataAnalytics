...
AVTM<-read.table("DataSciencePrep/C1/Data/AV/Authpred/AVTM.csv",sep=",",stringsAsFactors=FALSE)
...
inspect(pos.corpus.tags)
inspect(pos.corpus.comments)
inspect(pos.corpus.categories)
...
pos.DTM.title<-removeSparseTerms(DocumentTermMatrix(pos.corpus.title),.99)

pos.DTM.text<-removeSparseTerms(DocumentTermMatrix(pos.corpus.text),0.99)

pos.DTM.tags<-removeSparseTerms(DocumentTermMatrix(pos.corpus.tags),0.99)

pos.DTM.comments<-removeSparseTerms(DocumentTermMatrix(pos.corpus.comments),0.99)

pos.DTM.categories<-removeSparseTerms(DocumentTermMatrix(pos.corpus.categories),0.99)
...
Train_AVTM<-subset(Final_AVTM_Df,Final_AVTM_Df$CompDate<="2014-07-06")
Test_AVTM<-subset(Final_AVTM_Df,Final_AVTM_Df$CompDate>"2014-07-06")
