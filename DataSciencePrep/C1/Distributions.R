...
#As you can see in figure B.5, the majority of the data is concentrated on the left side of
#the distribution, with the remaining quarter of the data spread out over a very long tail.